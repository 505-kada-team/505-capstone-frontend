      ...
      <div className="grid items-center gap-14 lg:grid-cols-2">
        ...
        <div className="order-1 lg:order-2">
          ...
          <p className="mt-6 font-body text-sm leading-relaxed text-foreground/70">
            Instead of only presenting charts, the dashboard interprets current
            business data, identifies potential problems, and recommends a concrete
            next action — before the problem shows up in next week&apos;s report.
          </p>
        </div>
      </div>
    </section>
