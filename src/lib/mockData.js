...
export const mockProducts = [
  {
    id: 'prod-001',
    name: 'Latte',
    image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQRHV4c9P4IXb6Dsk1F69YM13GJU9NuO-WIvNit9Ed_QA&s=10',
    price: 12700,
    discountPrice: null,
...
export const initialIssues = [
  { id: 'ISS-001', title: 'Inventory Mismatch', context: 'Inventory', date: '2026-07-20', description: 'Jumlah stok di sistem tidak sesuai fisik.', reportedBy: 'Budi (Cashier)' },
  { id: 'ISS-002', title: 'Menu Link Broken', context: 'Menu', date: '2026-07-20', description: 'Link gambar menu Matcha Drink rusak.', reportedBy: 'Siti (Cashier)' },
  { id: 'ISS-003', title: 'Stock Level Error', context: 'Inventory', date: '2026-07-19', description: 'Stok Susu UHT tidak update otomatis.', reportedBy: 'Agus (Cashier)' },
  { id: 'ISS-004', title: 'Item Image Missing', context: 'Menu', date: '2026-07-18', description: 'Foto produk Cappuccino belum di-upload.', reportedBy: 'Dewi (Cashier)' },
  { id: 'ISS-005', title: 'Wrong Price Displayed', context: 'Menu', date: '2026-07-17', description: 'Harga Latte tampil salah di kasir.', reportedBy: 'Budi (Cashier)' },
  { id: 'ISS-006', title: 'Barcode Not Found', context: 'Inventory', date: '2026-07-16', description: 'Barcode Cup Plastik tidak terbaca scanner.', reportedBy: 'Siti (Cashier)' },
  { id: 'ISS-007', title: 'Printer Offline', context: 'Hardware', date: '2026-07-15', description: 'Printer struk tidak merespon.', reportedBy: 'Agus (Cashier)' },
  { id: 'ISS-008', title: 'Duplicate Category', context: 'Menu', date: '2026-07-14', description: 'Kategori "Ingredient" muncul 2 kali.', reportedBy: 'Dewi (Cashier)' },
  { id: 'ISS-009', title: 'Unit Conversion Wrong', context: 'Inventory', date: '2026-07-13', description: 'Konversi Kg ke gram salah hitung.', reportedBy: 'Budi (Cashier)' },
  { id: 'ISS-010', title: 'Login Session Expired', context: 'System', date: '2026-07-12', description: 'Sesi login terputus terlalu cepat.', reportedBy: 'Siti (Cashier)' },
];