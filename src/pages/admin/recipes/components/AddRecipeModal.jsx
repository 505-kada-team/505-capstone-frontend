          ...
          <div className="flex-1 overflow-y-auto p-6 min-h-0">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
              ...
              <div className="lg:col-span-6 space-y-5">
                ...
                <div className="grid grid-cols-2 gap-4 bg-muted/10 p-4 rounded-xl border border-border/80">
                ...
                <div className="space-y-1.5">
                  ...
                  <div
                    className={`border border-dashed rounded-xl p-4 flex flex-col items-center justify-center relative transition-all min-h-[140px] ${
                      dragActive
                ...
                <div className="space-y-1.5">
                  ...
                  <Textarea
                    placeholder="Catatan porsi, penyajian, atau instruksi pembuatan resep..."
                    className="resize-none bg-muted/10 h-28 text-sm"
              ...
              <div className="lg:col-span-6 flex flex-col h-full min-h-[400px] border-t lg:border-t-0 lg:border-l pt-6 lg:pt-0 lg:pl-8 border-border">
                ...
                <div className="flex-1 space-y-3 min-h-[300px] max-h-[440px] overflow-y-auto pr-2 custom-scrollbar border rounded-xl p-3 bg-muted/5 border-border/80">
                  {fields.length === 0 ? (
                    <div className="h-full flex flex-col items-center justify-center py-20 text-center text-muted-foreground">
                      ...
                      <p className="text-xs text-muted-foreground mt-1 max-w-[220px]">
                        Add inventory items (espresso, milk, syrup, etc.) to calculate the recipe cost.
                      </p>
                    </div>
                  ) : (
                        ...
                        <div key={field.id} className="flex gap-2.5 items-start bg-background p-2.5 rounded-lg border shadow-xs relative group">
                          ...
                          <div className="flex-1">
                            <Select
                              ...
                              onValueChange={(val) => form.setValue(`ingredients.${index}.inventoryId`, val, { shouldValidate: true })}
                              value={watchInvId || ''}
                            >
                              ...
                              <SelectContent>
                                {inventories.filter(i => i.status === 'active').map((inv) => (
                            ...
                            {form.formState.errors.ingredients?.[index]?.inventoryId && (
                              <p className="text-destructive text-[10px] font-semibold mt-1">
                                {form.formState.errors.ingredients[index].inventoryId.message}
                              </p>
                            )}
                          </div>
                          ...
                          <div className="w-32 relative">
                            <Input
                              type="number"
                              placeholder="Qty"
                              className="h-10 pr-12 font-mono text-sm bg-muted/10"
                          ...
                          <Button
                            ...
                            variant="ghost"
                            size="icon"
                            className="text-muted-foreground hover:text-destructive hover:bg-destructive/10 h-10 w-10 flex-shrink-0 border border-transparent hover:border-destructive/20"
                ...
                <div className="mt-4 pt-3 border-t flex flex-col gap-2">
                  ...
                  {form.formState.errors.ingredients && !Array.isArray(form.formState.errors.ingredients) && (
