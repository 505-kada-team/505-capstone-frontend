  ...
  return (
    <div className="flex flex-col gap-0 h-full overflow-hidden">
      ...
      <div className="flex gap-6 flex-1 min-h-0 flex-col lg:flex-row">
        ...
        {/* lg:h-full agar aside ikut stretch penuh mengikuti tinggi row di desktop */}
        <aside className="w-full lg:w-72 shrink-0 flex flex-col gap-3 lg:h-full">
          ...
          {/* flex-1 di desktop: menyerap sisa ruang kosong sehingga Pagination
              otomatis terdorong ke paling bawah container, tanpa scroll.
              Di mobile ini nggak berefek karena aside nggak punya height constraint,
              jadi posisi tetap seperti semula (sudah benar menurut kamu). */}
