          ...
          {isLoading || !plan ? (
            ...
            <>
              ...
              <DialogFooter className="flex justify-between items-center sm:justify-between w-full mt-4">
                <Button variant="outline" className="text-destructive border-destructive/50 hover:bg-destructive/10" onClick={reject} disabled={isMutating}>
                  Remove
                </Button>
                <Button className="bg-[#2D241E] hover:bg-[#2D241E]/90 text-primary-foreground" onClick={approve} disabled={isMutating}>
