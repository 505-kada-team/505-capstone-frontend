  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-center justify-between">
        <PageHeader title="Production Plan" badges={[{ label: 'DRAFT PLAN', variant: 'low stock' }]} subtitle="Plan your selling and estimate the flow" />
        <Button className="bg-[#F97316] hover:bg-[#F97316]/90 text-white gap-2 font-medium" onClick={() => setView('history')}>
